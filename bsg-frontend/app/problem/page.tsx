        ...
        <div
            ...
            >
                <ResizablePanel maxSize={50} className={'bg-inputBackground'}>
                    <Tabs defaultValue="problem" className="flex-1 w-fit bg-inputBackground">
                        ...
                        <TabsContent value="submissions">Previous submissions</TabsContent>
                            ...
                            <div className={'flex-row flex m-10'}>
                                <Tabs defaultValue="case1" className="flex-1 w-fit ">
                                    ...
                                    <TabsContent value="case1">
                                        <div className={'mt-5'}>
                                            <p>Input=</p>
                                            <div className={'bg-inputBackground flex flex-1 rounded-2xl mt-2'}>
                                                <p className={'p-3 text-xl'}>[["A","B","C","E"],["S","F","C","S"],["A","D","E","E"]]</p>
                                            </div>
