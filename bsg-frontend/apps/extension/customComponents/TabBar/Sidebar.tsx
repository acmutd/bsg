                        ...
                        >
                            ...
                            >
                                <div className={`flex flex-col gap-1 text-sm ${(activeTab === 'chat') ? '' : 'opacity-60'}`}>
                                    ...
                                    <div className="-rotate-90 w-5 h-5 flex items-center justify-center text-[rgb(0,123,255)]">
                                        <svg
                            ...
                            >
                                <div className={`flex flex-col gap-1 text-sm ${(activeTab === 'leaderboard') ? '' : 'opacity-60'}`}>
                                    ...
                                    <div className="-rotate-90 w-5 h-5 flex items-center justify-center text-[rgb(255,183,0)]">
                                        <svg
                                            className="w-4 h-4 overflow-visible"
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 38 38"
                            ...
                            >
                                <div className={`flex flex-col gap-1 text-sm ${(activeTab === 'statistics') ? '' : 'opacity-60'}`}>
                                    ...
                                    <div className="-rotate-90 w-5 h-5 flex items-center justify-center text-[rgb(2,177,40)]">
                                        <svg
                                            className="w-4 h-4 overflow-visible"
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 38 32"
