...
export default function ChatPage() {
    ...
    return (
        <div className="flex flex-col w-full bg-background">
            ...
            <header className="bg-inputBackground px-4 py-3 flex items-center justify-between">
                <div className="flex flex-col">
                    ...
                    <div
                        ...
                        <div className="text-2xl font-semibold">g0oN3R</div>
            ...
            {activeTab === 'chat' && (
                <div ref={containerRef} className="flex-1 relative overflow-y-auto p-4 space-y-4">
                    {messages.map((msg, i) => (
                        <div className={'bg-inputBackground'} key={i}>{msg.data}</div>
                    ))}
                    <div className="absolute bottom-0 left-0 px-4 py-4 flex items-center space-x-2">
                        <input
                            ref={inputRef}
