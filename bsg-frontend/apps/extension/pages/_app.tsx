...
import { faPaperPlane, faSmile, faCopy, faEllipsisVertical, faRightFromBracket } from '@fortawesome/free-solid-svg-icons'
      ...
      <div className="flex flex-col h-screen bg-[#262626]">
        <header className="bg-[#1e1e1f] border-b border-gray-700 px-4 py-3 flex items-center justify-between">
          ...
          <DropdownMenu
            ...
            onOpenChange={(open) => {
              if (!open) setMenuState("closed")
              else setMenuState("menu")
            }}>
            ...
            >
              {menuState == "menu" &&
                <>
                  ...
                  <DropdownMenuGroup>
                    <DropdownMenuItem
                      onSelect={() => { setCurrentRoom(null); setLoggedIn(false) }}
